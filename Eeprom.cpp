...
//  SAFE_VALUE_SET_DEG =   EEPROM.read(2);
  ...
  EEPROM.get(150, SAFE_VALUE_SET_DEG);
...
void Rclass ::EEPROM_CLEAR()
{
  STIR_VALUE_SET = 0;
  DEGREE_VALUE_SET = 0; 
  SAFE_VALUE_SET_DEG = 300;
  SAFE_VALUE_SET_FAH = 212;
  CAL_SELECT_VALUE = 0;
  ERROR_CAL1 = SIGN=0;
  ERROR_SET_IN_DEG_FLAG =1; 
  ERROR_SET_IN_FAH_FLAG =0;
  CAL2_RAW_LOW_VALUE_CONV = 50;
  CAL2_RAW_HIGH_VALUE_CONV  = 140;
  MASTER_LOW_CONV  = 39;
  MASTER_HIGH_CONV  = 87;
